(() => {
  // --- Domain definitions ---
  const DOMAINS = [
    { id: 0, name: "All Domains", desc: "All 130 practice questions", icon: "\uD83D\uDCDA" },
  ...
  // Domain boundaries: D1=1-31, D2=32-45, D3=46-79, D4=80-108, D5=109-130
  function getDomain(questionId) {
    if (questionId <= 31) return 1;
    if (questionId <= 45) return 2;
    if (questionId <= 79) return 3;
    if (questionId <= 108) return 4;
    return 5;
  }
